...
module.exports = { CreateService: async (topic, type, userId, data, timestamp) => {
  try {
    ...
    return (typeof (savedTopic) === 'object' && typeof (savedType) === 'object' && typeof (createdlink) === 'object') ? {'post data': createdlink, msg: 'posted succesfully'} : { msg: 'unknown error try again'}
  } catch (e) {
    console.log(e)
  }
}
