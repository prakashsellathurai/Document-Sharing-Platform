function split (value, separator, includeSeparator, openLevel, closeLevel, firstOnly) {
  ...
  if (value.indexOf(openLevel) == -1 && !includeSeparator && !firstOnly) { return value.split(separator) }
  ...
  if (lastStart < cursor + 1) {
    ...
    if (!includeSeparator && (withRegex ? separator.test(lastCharacter) : lastCharacter == separator)) { lastValue = lastValue.substring(0, lastValue.length - 1) }
