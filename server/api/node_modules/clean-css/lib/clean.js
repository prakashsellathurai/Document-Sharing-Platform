...
CleanCSS.prototype.minify = function (data, callback) {
  ...
  if (context.options.sourceMap) { context.inputSourceMapTracker = new InputSourceMapTracker(context) }
...
function minify (context, data) {
  ...
  if (options.benchmark) { run = benchmark(run) }
  ...
  if (options.advanced) { advancedOptimize(tokens, options, context, true) }
