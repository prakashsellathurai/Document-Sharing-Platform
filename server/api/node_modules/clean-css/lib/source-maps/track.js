...
function trackPrefix (value, context, interestingContent) {
  ...
  while (true) {
    if (withoutContent == total - 1) { break }
...
function sourceFor (originalMetadata, contextMetadata, context) {
  ...
  if (source && context.resolvePath) { return context.resolvePath(contextMetadata.source, source) }
...
function track (data, context, snapshotMetadata, fallbacks) {
  ...
  if (untracked) { trackSuffix(untracked, context) }
