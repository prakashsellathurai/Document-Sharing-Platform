...
function _wrapDefault (name, property, compactable) {
  ...
  if (descriptor.doubleValues && descriptor.defaultValue.length == 2) { return wrapSingle([[name, property.important], [descriptor.defaultValue[0]], [descriptor.defaultValue[1]]]) } else if (descriptor.doubleValues && descriptor.defaultValue.length == 1) { return wrapSingle([[name, property.important], [descriptor.defaultValue[0]]]) } else { return wrapSingle([[name, property.important], [descriptor.defaultValue]]) }
}
...
function listStyle (property, compactable, validator) {
  ...
  if (values.length > 0 && validator.isValidListStylePosition(values[0][0])) { position.value = [values[0]] }
