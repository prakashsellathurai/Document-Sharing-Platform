...
function backgroundImage (property1, property2, validator) {
  ...
  if (image2 == 'none' || image2 == 'inherit' || validator.isValidUrl(image2)) { return true }
  if (image1 == 'none' || image1 == 'inherit' || validator.isValidUrl(image1)) { return false }
...
function color (property1, property2, validator) {
  ...
  if (!validator.colorOpacity && (validator.isValidRgbaColor(color1) || validator.isValidHslaColor(color1))) { return false }
  if (!validator.colorOpacity && (validator.isValidRgbaColor(color2) || validator.isValidHslaColor(color2))) { return false }

  // (hex | named)
  if (validator.isValidNamedColor(color2) || validator.isValidHexColor(color2)) { return true }
  if (validator.isValidNamedColor(color1) || validator.isValidHexColor(color1)) { return false }

  // (rgba|hsla)
  if (validator.isValidRgbaColor(color2) || validator.isValidHslaColor(color2)) { return true }
  if (validator.isValidRgbaColor(color1) || validator.isValidHslaColor(color1)) { return false }
...
function sameFunctionOrValue (property1, property2, validator) {
  ...
  if (validator.areSameFunction(value1, value2)) { return true }
...
function unit (property1, property2, validator) {
  ...
  if (validator.isValidAndCompatibleUnitWithoutFunction(value1) && !validator.isValidAndCompatibleUnitWithoutFunction(value2)) { return false }

  if (validator.isValidUnitWithoutFunction(value2)) { return true }
  if (validator.isValidUnitWithoutFunction(value1)) { return false }
