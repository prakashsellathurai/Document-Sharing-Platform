(function (global, factory) {
  ...
  lp$1.parseStatement = function () {
    ...
    switch (starttype) {
      ...
      case acorn.tokTypes._for:
        ...
        if (this.tok.type === acorn.tokTypes._in || this.isContextual('of')) { return this.parseForIn(node, this.toAssignable(init)) }
  ...
  lp$1.parseBlock = function () {
    ...
    var blockIndent = this.curIndent, line = this.curLineStart
    node.body = []
    while (!this.closes(acorn.tokTypes.braceR, blockIndent, line, true)) { node.body.push(this$1.parseStatement()) }
    this.popCx()
    this.eat(acorn.tokTypes.braceR)
  ...
  lp$2.parseSubscripts = function (base, start, noCalls, startIndent, line) {
    ...
    for (;;) {
      if (this$1.curLineStart != line && this$1.curIndent <= startIndent && this$1.tokenStartsLine()) {
        if (this$1.tok.type == acorn.tokTypes.dot && this$1.curIndent == startIndent) { --startIndent } else { return base }
      }
