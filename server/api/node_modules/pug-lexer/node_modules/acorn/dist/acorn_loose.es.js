...
lp$1.parseStatement = function () {
  ...
  switch (starttype) {
    ...
    case tokTypes._for:
      ...
      if (this.tok.type === tokTypes._in || this.isContextual('of')) { return this.parseForIn(node, this.toAssignable(init)) }
...
lp$1.parseBlock = function () {
  ...
  var blockIndent = this.curIndent, line = this.curLineStart
  node.body = []
  while (!this.closes(tokTypes.braceR, blockIndent, line, true)) { node.body.push(this$1.parseStatement()) }
  this.popCx()
  this.eat(tokTypes.braceR)
...
lp$2.parseSubscripts = function (base, start, noCalls, startIndent, line) {
  ...
  for (;;) {
    if (this$1.curLineStart != line && this$1.curIndent <= startIndent && this$1.tokenStartsLine()) {
      if (this$1.tok.type == tokTypes.dot && this$1.curIndent == startIndent) { --startIndent } else { return base }
    }
    ...
    if (this$1.eat(tokTypes.dot)) {
      ...
      if (maybeAsyncArrow && this$1.eat(tokTypes.arrow)) { return this$1.parseArrowExpression(this$1.startNodeAt(start), exprList, true) }
      var node$2 = this$1.startNodeAt(start)
      node$2.callee = base
  ...
  switch (this.tok.type) {
    ...
    case tokTypes.name:
      ...
      if (id.name === 'async' && !this.canInsertSemicolon()) {
        if (this.eat(tokTypes._function)) { return this.parseFunction(this.startNodeAt(start), false, true) }
