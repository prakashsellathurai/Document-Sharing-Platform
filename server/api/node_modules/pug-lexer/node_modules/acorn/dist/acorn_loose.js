...
// Registered plugins
  ...
  lp$1.parseStatement = function () {
    ...
    switch (starttype) {
      ...
      case __acorn.tokTypes._for:
        ...
        if (this.tok.type === __acorn.tokTypes._in || this.isContextual('of')) { return this.parseForIn(node, this.toAssignable(init)) }
  ...
  lp$1.parseBlock = function () {
    ...
    var blockIndent = this.curIndent, line = this.curLineStart
    node.body = []
    while (!this.closes(__acorn.tokTypes.braceR, blockIndent, line, true)) { node.body.push(this$1.parseStatement()) }
    this.popCx()
    this.eat(__acorn.tokTypes.braceR)
  ...
  lp$2.parseSubscripts = function (base, start, noCalls, startIndent, line) {
    ...
    for (;;) {
      if (this$1.curLineStart != line && this$1.curIndent <= startIndent && this$1.tokenStartsLine()) {
        if (this$1.tok.type == __acorn.tokTypes.dot && this$1.curIndent == startIndent) { --startIndent } else { return base }
      }
      ...
      if (this$1.eat(__acorn.tokTypes.dot)) {
        ...
        node.object = base
        if (this$1.curLineStart != line && this$1.curIndent <= startIndent && this$1.tokenStartsLine()) { node.property = this$1.dummyIdent() } else { node.property = this$1.parsePropertyAccessor() || this$1.dummyIdent() }
        node.computed = false
        ...
        if (maybeAsyncArrow && this$1.eat(__acorn.tokTypes.arrow)) { return this$1.parseArrowExpression(this$1.startNodeAt(start), exprList, true) }
        var node$2 = this$1.startNodeAt(start)
        node$2.callee = base
    ...
    switch (this.tok.type) {
      ...
      case __acorn.tokTypes.name:
        ...
        if (id.name === 'async' && !this.canInsertSemicolon()) {
          if (this.eat(__acorn.tokTypes._function)) { return this.parseFunction(this.startNodeAt(start), false, true) }
      ...
      // (a,)=>a // SequenceExpression makes dummy in the last hole. Drop the dummy.
          ...
          if (params.length && isDummy(params[params.length - 1])) { params.pop() }
...
// if possible.
  ...
  lp$2.toAssignable = function (node, binding) {
    ...
    // Okay
      ...
      for (var i = 0; i < props.length; i++) { props[i].value = this$1.toAssignable(props[i].value, binding) }
  ...
  lp$2.toAssignableList = function (exprList, binding) {
    ...
    for (var i = 0; i < exprList.length; i++) { exprList[i] = this$1.toAssignable(exprList[i], binding) }
    return exprList
  }
