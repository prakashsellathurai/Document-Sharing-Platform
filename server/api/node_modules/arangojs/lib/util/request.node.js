...
exports.default = function (baseUrl, agentOptions, agent) {
  ...
  function request (_ref, cb) {
    ...
    var path = baseUrlParts.pathname ? url.pathname ? (0, _joinPath2.default)(baseUrlParts.pathname, url.pathname) : baseUrlParts.pathname : url.pathname
...
var isBrowser = exports.isBrowser = false
