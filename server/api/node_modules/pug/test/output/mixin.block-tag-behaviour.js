...
function template (locals) {
  ...
  pug_mixins['article'] = pug_interp = function (name) {
    ...
    pug_html = pug_html + '<section class="article"><h1>' + pug_escape((pug_interp = name) == null ? '' : pug_interp) + '</h1>'
    block && block()
  ...
  pug_mixins['article'] = pug_interp = function (name) {
    var block = this && this.block, attributes = this && this.attributes || {}
    pug_html = pug_html + '<section class="article"><h1>' + pug_escape((pug_interp = name) == null ? '' : pug_interp) + '</h1><p>'
    block && block()
