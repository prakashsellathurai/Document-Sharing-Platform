...
function template (locals) {
  ...
  items.forEach(function (item) {
    {
      pug_html = pug_html + '<li>' + pug_escape((pug_interp = item) == null ? '' : pug_interp) + '</li>'
    }
  })
  pug_html = pug_html + '</ul>'
  var items = [ 1, 2, 3 ]
  ...
  (function () {
    ...
    if (typeof $$obj.length === 'number') {
      for (var i = 0, $$l = $$obj.length; i < $$l; i++) {
        var item = $$obj[i]
        pug_html = pug_html + '<li' + pug_attr('class', pug_classes([ 'item-' + i ], [ true ]), false, false) + '>' + pug_escape((pug_interp = item) == null ? '' : pug_interp) + '</li>'
      }
    } else {
      var $$l = 0
      for (var i in $$obj) {
        ...
        (function () {
          ...
          if (typeof $$obj.length === 'number') {
            for (var pug_index4 = 0, $$l = $$obj.length; pug_index4 < $$l; pug_index4++) {
              ...
              pug_html = pug_html + '<li>' + pug_escape((pug_interp = n) == null ? '' : pug_interp) + ': ' + pug_escape((pug_interp = l) == null ? '' : pug_interp) + '</li>'
            }
          } else {
            var $$l = 0
  ...
  (function () {
    ...
    if (typeof $$obj.length === 'number') {
      for (var pug_index6 = 0, $$l = $$obj.length; pug_index6 < $$l; pug_index6++) {
        ...
        pug_html = pug_html + '<li>' + pug_escape((pug_interp = n) == null ? '' : pug_interp) + '</li>'
      }
    } else {
      var $$l = 0
