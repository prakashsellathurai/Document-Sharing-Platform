      ...
      if (typeof $$obj.length === 'number') {
        if ($$obj.length) {
          for (var pug_index0 = 0, $$l = $$obj.length; pug_index0 < $$l; pug_index0++) {
            ...
            pug_html = pug_html + '<li>' + pug_escape((pug_interp = user.name) == null ? '' : pug_interp) + '</li>'
          }
        } else {
      ...
      if (typeof $$obj.length === 'number') {
        if ($$obj.length) {
          for (var key = 0, $$l = $$obj.length; key < $$l; key++) {
            var val = $$obj[key]
            pug_html = pug_html + '<li>' + pug_escape((pug_interp = key) == null ? '' : pug_interp) + ': ' + pug_escape((pug_interp = val) == null ? '' : pug_interp) + '</li>'
          }
        } else {
