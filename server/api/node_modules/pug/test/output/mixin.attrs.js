...
function template (locals) {
  ...
  pug_mixins['centered'] = pug_interp = function (title) {
    ...
    if (title) {
      pug_html = pug_html + '<h1' + pug_attr('class', pug_classes([ attributes.class ], [ true ]), false, false) + '>' + pug_escape((pug_interp = title) == null ? '' : pug_interp) + '</h1>'
    }
    block && block()
    if (attributes.href) {
  ...
  pug_mixins['work_filmstrip_item'] = pug_interp = function (work) {
    var block = this && this.block, attributes = this && this.attributes || {}
    pug_html = pug_html + '<div' + pug_attrs(attributes, false) + '>' + pug_escape((pug_interp = work) == null ? '' : pug_interp) + '</div>'
  }
  ...
  pug_mixins['my-mixin'] = pug_interp = function (arg1, arg2, arg3, arg4) {
    var block = this && this.block, attributes = this && this.attributes || {}
    pug_html = pug_html + '<p>' + pug_escape((pug_interp = arg1) == null ? '' : pug_interp) + '</p><p>' + pug_escape((pug_interp = arg2) == null ? '' : pug_interp) + '</p><p>' + pug_escape((pug_interp = arg3) == null ? '' : pug_interp) + '</p><p>' + pug_escape((pug_interp = arg4) == null ? '' : pug_interp) + '</p>'
  }
  pug_mixins['foo'].call({
    attributes: {
      class: 'baz',
