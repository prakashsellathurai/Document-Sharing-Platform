...
function template (locals) {
  ...
  pug_mixins['comment'] = pug_interp = function (title, str) {
    ...
    pug_html = pug_html + '<div class="comment"><h2>' + pug_escape((pug_interp = title) == null ? '' : pug_interp) + '</h2><p class="body">' + pug_escape((pug_interp = str) == null ? '' : pug_interp) + '</p></div>'
  }
  pug_mixins['comment'] = pug_interp = function (title, str) {
    var block = this && this.block, attributes = this && this.attributes || {}
    pug_html = pug_html + '<div class="comment"><h2>' + pug_escape((pug_interp = title) == null ? '' : pug_interp) + '</h2><p class="body">' + pug_escape((pug_interp = str) == null ? '' : pug_interp) + '</p></div>'
  ...
  pug_mixins['foobar'] = pug_interp = function (str) {
    var block = this && this.block, attributes = this && this.attributes || {}
    pug_html = pug_html + '<div id="interpolation">' + pug_escape((pug_interp = str + 'interpolated') == null ? '' : pug_interp) + '</div>'
  }
  var suffix = 'bar'
