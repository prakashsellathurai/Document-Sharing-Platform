...
pp.parseForStatement = function (node) {
  ...
  if (this.type === tt._var || this.type === tt._const || isLet) {
    ...
    if ((this.type === tt._in || (this.options.ecmaVersion >= 6 && this.isContextual('of'))) && init.declarations.length === 1 &&
        !(kind !== 'var' && init.declarations[0].init)) { return this.parseForIn(node, init) }
...
pp.checkPatternExport = function (exports, pat) {
  ...
  if (type == 'Identifier') { this.checkExport(exports, pat.name, pat.start) } else if (type == 'ObjectPattern') {
    for (let i = 0; i < pat.properties.length; ++i) { this.checkPatternExport(exports, pat.properties[i].value) }
...
pp.checkVariableExport = function (exports, decls) {
  if (!exports) return
  for (let i = 0; i < decls.length; i++) { this.checkPatternExport(exports, decls[i].id) }
}
