...
import { isAqlLiteral, isAqlQuery } from "./aql-query";
import { DocumentCollection, EdgeCollection, constructCollection, isArangoCollection } from "./collection";
...
export class Database {
    ...
    useBasicAuth(username = "root", password = "") {
        this._connection.setHeader("authorization", `Basic ${btoa(`${username}:${password}`)}`);
        return this;
    }
    get() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    collections(excludeSystem = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return collections.map((data) => constructCollection(this._connection, data));
        });
    }
