...
export declare class Database {
    ...
    transaction(collections: CollectionName | CollectionName[] | TransactionCollections, action: string, params?: any): Promise<any>;
    transaction(collections: CollectionName | CollectionName[] | TransactionCollections, action: string, params?: any, lockTimeout?: number): Promise<any>;
