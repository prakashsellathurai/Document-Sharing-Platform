...
export declare class DocumentCollection extends BaseCollection {
    ...
    document(documentHandle: DocumentHandle): Promise<any>;
...
export declare class EdgeCollection extends BaseCollection {
    ...
    constructor(connection: Connection, name: string);
    protected _documentPath(documentHandle: DocumentHandle): string;
    edge(documentHandle: DocumentHandle): Promise<any>;
...
export declare function constructCollection(connection: Connection, data: any): DocumentCollection | EdgeCollection;
