...
export declare class Connection {
    ...
    private _runQueue();
    private _buildUrl({absolutePath, basePath, path, qs});
    private _sanitizeEndpointUrl(url);
    ...
    request({host, method, body, expectBinary, isBinary, isJsonStream, headers, ...urlInfo}: RequestOptions): Promise<ArangojsResponse>;
}
